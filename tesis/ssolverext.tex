...
\begin{table}\label{distrospamela8}
\begin{footnotesize}
...
siendo resueltos y partirlo. Llamaremos \textbf{frecuencia objetivo} al umbral, entendido como 
...
mientras que una ventana más pequeña se adapta más rápidamente y consecuentemente mostrará mayor variabilidad. La frecuencia de checkeo administra cuánto tiempo de
...
del objetivo el sistema reaccionará. Por otro lado, una frecuencia alta --mayor
...
$w_{overwhelmed}$. Vale la pena notar que si un \w solicitara las $n$ tareas que mejor califican según el criterio de elección, este concentrará un conjunto de tareas de alta prioridad, generando un potencial problema de contención.
...
\begin{minipage}{\textwidth}
	...
	\begin{tabular}{lrrrrrr}
		...
		Pamela	&	10	&	$>$1209600\footnote{Se ejecutó por 14 días sin que el \ssolver consiga un resultado}	&	5046.84	&	$>$239.67x	&	$>$3.74 \\
		\cmidrule(r){1-6}
