...
% Hemos observado que la partición de un problema en subproblemas a menudo
% conlleva una dosis considerable de retrabajo, y hemos conjeturado que el
% aprovechamiento de las cláusulas aprendidas durante el análisis parcial de un
% problema difícil es importante para eliminar (o al menos mitigar el impacto
% negativo de) dicho retrabajo. Para llevar a la práctica una serie de
% experimentos que permitan poner a prueba esta hipótesis es necesario tomar
% ciertas decisiones importantes acerca de:
