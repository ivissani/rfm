...
subproblema cuando otro \w le solicite otro de sus subproblemas
pendientes.

Es claro que, ante esta situación, no sería aceptable que el \w que está
esperando una tarea deba verse obligado a esperar a que el \w que generó
dicha tarea deje de \solvear para poder acceder a la misma; esto da origen
a un requerimiento de asincronicidad \emph{solving/serving}.

Sin embargo, tampoco sería aceptable que el impacto de servir tareas bajo demanda vaya en
detrimento del análisis (que es, al fin y al cabo, la tarea principal del \w);
...
En resumen, lograr una buena ortogonalidad entre análisis y migración de tareas es
importante para lograr escalabilidad, y además sienta las bases para mecanismos
