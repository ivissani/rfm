...
de un problema (y es exponencial), la experiencia muestra que es común
hallar problemas sumamente difíciles con pocas variables, así como problemas
que resulten sencillos a pesar de involucrar grandes
cantidades de variables. En general, cualquier estimador estático para
intentar predecir la dificultad de un problema arbitrario hace agua en la
práctica.
