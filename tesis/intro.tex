...
que dio origen a lo que hoy se conoce como procedimiento \cdcl. A partir de ese
momento una serie de optimizaciones han sido desarrolladas para cada una de las
partes del algoritmo desarrollado por Marques y Silva. La mayoría de estas
optimización \todo[inline]{¿Todas?} son heurísticas para cada uno de los puntos
de decisión del algoritmo \footnote{Para un relevamiento completo de las
optimizaciones aplicadas al algoritmo \cdcl ver \cite{manthey:mathesis}}.
